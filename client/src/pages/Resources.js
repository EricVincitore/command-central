...
class Resources extends Component {
  render() {
    return (
        <div className="page resourcePage">
            <Container fluid>
                <Row>
                <Col md="12" sm="12">
                    <Jumbotron/>
                ...
                <Row>
                    <Col md="12" sm="12">
                        <h2 className="resourceText">Game Philosophy</h2>
                        ...
                        <a className="resourceLink" href="https://mtgcommander.net/index.php/the-philosophy-of-commander/" target="_blank" rel="noopener noreferrer">
                            <strong>
                ...
                <Row>
                    <Col md="12" sm="12">
                        <h2 className="resourceText">Rules and Regulations</h2>
                        <p className="resourceText">
                        ...
                        <h4 className="resourceText">Deck Construction Rules</h4>
                        ...
                        <h4 className="resourceText">Play Rules</h4>
                        <ul className="resourceList">
                        ...
                        <a className="resourceLink" href="https://magic.wizards.com/en/content/commander-format" target="_blank" rel="noopener noreferrer">
                            <strong>
                                Click here for the full gameplay introduction from Wizards of the Coast.
                            </strong>
                        </a>
                        <br/>
                        <a className="resourceLink" href="https://mtgcommander.net/index.php/rules/" target="_blank" rel="noopener noreferrer">
                            <strong>
                ...
                <Row>
                    <Col md="12" sm="12">
                        <h2 className="resourceText">Banned Card List</h2>
                        <p className="resourceText">
                        ...
                        <a className="resourceLink" href="https://mtgcommander.net/index.php/banned-list/" target="_blank" rel="noopener noreferrer">
                            <strong>
                                Click here for the official Commander banned card list.
                            </strong>
                        </a>
                        <br/>
                        <a className="resourceLink" href="https://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&special=true&type=+%5b%22Conspiracy%22%5d" target="_blank" rel="noopener noreferrer">
                            <strong>
                                Click here for the list of Conspiracy cards.
                            </strong>
                        </a>
                        <br/>
                        <a className="resourceLink" href="https://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&text=+%5b%22%20ante.%22%5d" target="_blank" rel="noopener noreferrer">
                            <strong>
                ...
                <Row>
                    <Col md="12" sm="12">
                        <h2 className="resourceText">Privacy Policy</h2>
                        <a className="resourceLink" href="https://www.iubenda.com/privacy-policy/61199406" title="Privacy Policy ">
                            <strong>
