      ...
      <Container fluid>
        ...
        <Row>
            <Col md="12" sm="12">
                ...
                <a href="https://mtgcommander.net/index.php/the-philosophy-of-commander/" target="_blank" rel="noopener noreferrer">
                    <strong>
        ...
        <Row>
            <Col md="12" sm="12">
                ...
                <a href="https://magic.wizards.com/en/content/commander-format" target="_blank" rel="noopener noreferrer">
                    <strong>
                        Click here for the full gameplay introduction from Wizards of the Coast.
                    </strong>
                </a>
                <br/>
                <a href="https://mtgcommander.net/index.php/rules/" target="_blank" rel="noopener noreferrer">
                    <strong>
        ...
        <Row>
            <Col md="12" sm="12">
                ...
                <a href="https://mtgcommander.net/index.php/banned-list/" target="_blank" rel="noopener noreferrer">
                    <strong>
                        Click here for the official Commander banned card list.
                    </strong>
                </a>
                <br/>
                <a href="https://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&special=true&type=+%5b%22Conspiracy%22%5d" target="_blank" rel="noopener noreferrer">
                    <strong>
                        Click here for the list of Conspiracy cards.
                    </strong>
                </a>
                <br/>
                <a href="https://gatherer.wizards.com/Pages/Search/Default.aspx?action=advanced&text=+%5b%22%20ante.%22%5d" target="_blank" rel="noopener noreferrer">
                    <strong>
